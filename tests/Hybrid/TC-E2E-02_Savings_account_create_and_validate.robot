...
*** Test Cases ***
TC-E2E-02 - Create Savings Account via UI Validate in API
    [Documentation]    Create SAVINGS account in UI and validate account details through API.
    [Tags]    HYBRID
    ...
    Should Be Equal As Strings    ${account_type}  SAVINGS
